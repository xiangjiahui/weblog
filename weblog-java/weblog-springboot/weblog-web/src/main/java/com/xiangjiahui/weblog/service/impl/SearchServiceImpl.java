...
import com.xiangjiahui.weblog.model.vo.search.VO.SearchArticlePageListRspVO;
...
public class SearchServiceImpl implements SearchService {
    ...
    public SearchServiceImpl(LuceneHelper luceneHelper) {
        this.luceneHelper = luceneHelper;
    }

    @Override
    public PageResponse searchArticlePageList(SearchArticlePageListReqVO searchArticlePageListReqVO) {
        int current = Math.toIntExact(searchArticlePageListReqVO.getCurrentPage());
