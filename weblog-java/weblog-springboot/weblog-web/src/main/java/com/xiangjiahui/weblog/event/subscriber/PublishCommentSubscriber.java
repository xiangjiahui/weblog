package com.xiangjiahui.weblog.event.subscriber;
...
import com.xiangjiahui.weblog.common.utils.MailUtil;
import com.xiangjiahui.weblog.event.PublishCommentEvent;
...
public class PublishCommentSubscriber implements ApplicationListener<PublishCommentEvent> {
    ...
    public PublishCommentSubscriber(CommentMapper commentMapper, BlogSettingsMapper blogSettingsMapper, MailUtil mailUtil) {
...
// 在这里处理收到的事件，可以是任何逻辑操作
        ...
        // 博客访问地址
        String domain = "http://43.139.2.157/#";
