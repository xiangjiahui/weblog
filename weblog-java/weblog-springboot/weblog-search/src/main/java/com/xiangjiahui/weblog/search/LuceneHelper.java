package com.xiangjiahui.weblog.search;
...
public class LuceneHelper {
    ...
    public void createIndex(String index, List<Document> documents) {
        try {
            ...
            String indexDir = getIndexDir(index);
    ...
    public String getIndexDir(String index) {
        return properties.getIndexDir() + File.separator + index;
    }
}
