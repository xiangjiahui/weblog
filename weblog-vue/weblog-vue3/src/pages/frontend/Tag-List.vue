      ...
      <div class="col-span-4 md:col-span-3 mb-3">
        ...
        <div v-if="tags.length > 1"
          ...
          <span v-for="(tag, index) in tags" :key="index"
                class="px-3 py-1 rounded-full inline-block mb-1 cursor-pointer bg-green-100 text-green-800 text-xs font-medium mr-2 px-3 py-1 rounded-full hover:bg-green-200 hover:text-green-900 dark:bg-green-900 dark:text-green-300">
                        {{ tag.name }}
                    </span>
        </div>
      </div>
